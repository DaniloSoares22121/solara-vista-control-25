    ...
    <div className="min-h-screen bg-gray-50 py-6">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div id="invoice-layout" ref={invoiceRef} className="bg-white shadow-xl rounded-lg overflow-hidden" style={{ width: '210mm', minHeight: '297mm', fontSize: '10pt' }}>
          ...
          {/* Header com design curvo verde aprimorado */}
          <div className="relative bg-gradient-to-r from-green-500 via-green-600 to-green-700 text-white" style={{ 
            ...
            <div className="flex justify-between items-start">
              <div className="flex items-baseline">
                <h1 className="text-6xl font-bold mr-3" style={{ fontFamily: 'Arial, sans-serif' }}>energy</h1>
                <h2 className="text-4xl font-light">PAY</h2>
              </div>
          ...
          <div className="p-8 space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-3">
                <h3 className="text-lg font-bold text-gray-800 mb-4 border-b border-gray-200 pb-2">DADOS DO CLIENTE</h3>
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-800 mb-4 border-b border-gray-200 pb-2">DETALHES DA FATURA</h3>
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-xl border-l-4 border-green-500 shadow-sm">
                  ...
                  <div className="bg-gradient-to-br from-red-50 to-red-100 p-4 rounded-xl border-l-4 border-red-500 shadow-sm">
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-xl border-l-4 border-blue-500 shadow-sm">
                  ...
                  <div className="bg-gradient-to-br from-green-100 to-green-200 p-4 rounded-xl border-l-4 border-green-600 shadow-sm">
            ...
            {/* Seção de Economia com melhor espaçamento */}
            <div className="bg-gradient-to-r from-green-50 to-green-100 p-6 rounded-2xl border border-green-200">
              <div className="flex items-center justify-center mb-6">
                ...
                <div className="text-center">
                  <h2 className="text-3xl font-bold text-gray-800">Economia com</h2>
                  <h2 className="text-3xl font-bold text-green-600">a Energy Pay ✓</h2>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-xl border-l-4 border-green-500 shadow-md">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-3xl font-bold text-green-600">{formatCurrency(data.economiaTotal)}</span>
                  </div>
                </div>
                <div className="bg-white p-6 rounded-xl border-l-4 border-green-500 shadow-md">
                  <div className="flex justify-between items-center">
                    <span className="text-lg font-bold text-gray-700">ECONOMIA ACUMULADA</span>
                    <span className="text-3xl font-bold text-green-600">R$ 7.474,01</span>
                  </div>
                </div>
              </div>
            </div>

            {/* Conteúdo Principal em Grid com melhor espaçamento */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              {/* Coluna Esquerda - Histórico */}
              <div>
                <div className="bg-gray-50 p-6 rounded-xl border shadow-sm">
                  <h3 className="text-lg font-bold text-gray-700 mb-6 text-center bg-green-600 text-white py-3 rounded-lg">HISTÓRICO DE ECONOMIA</h3>
                    ...
                    {data.historico.slice(0, 6).map((item, index) => (
                      <div key={index} className="flex items-center">
                        ...
                        <div className="flex-1 bg-gray-200 rounded-full h-8 relative overflow-hidden">
                          <div 
                            className="bg-gradient-to-r from-green-500 to-green-600 h-8 rounded-full flex items-center justify-end pr-3 shadow-inner" 
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="bg-gray-50 border border-t-0 rounded-b-xl p-6">
                    <div className="grid grid-cols-3 gap-4 text-sm font-bold text-gray-600 mb-4 pb-3 border-b border-gray-300">
                      <span></span>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 border border-t-0 p-6">
                    <h4 className="text-base font-bold text-green-600 mb-4">VALOR TOTAL DA ENERGIA SEM A ENERGY PAY</h4>
                    <div className="bg-white p-4 rounded-lg border">
                      <div className="grid grid-cols-4 gap-2 text-xs font-bold text-gray-600 mb-3 pb-2 border-b">
                        <span></span>
                        <span className="text-center">QUANTIDADE</span>
                  ...
                  <div className="bg-gray-50 border border-t-0 p-6">
                    <h4 className="text-base font-bold text-green-600 mb-4">VALOR TOTAL DA ENERGIA COM A ENERGY PAY</h4>
                    <div className="bg-white p-4 rounded-lg border">
                      <div className="grid grid-cols-2 gap-4 text-xs font-bold text-gray-600 mb-3 pb-2 border-b">
                        <span></span>
                        <span className="text-center">VALOR A PAGAR</span>
                      </div>
                      <div className="space-y-2 text-sm">
                  ...
                  {/* Cálculo da Economia */}
                  <div className="bg-green-100 border border-t-0 rounded-b-xl p-6 border-green-300">
                    ...
                    <div className="space-y-3 text-base">
                      ...
                      <div className="border-t-4 border-green-500 pt-4 mt-4 bg-white rounded-lg p-4">
            ...
            {/* Seção do Rodapé melhorada */}
            <div className="mt-12 space-y-8">
              <div className="text-center">
                <p className="text-base font-bold text-green-600 mb-8 bg-green-50 p-4 rounded-lg border border-green-200">
                  RECEBEDOR: J7 EMPREENDIMENTOS E CONSULTORIA LTDA - CNPJ: 14.375.534/0001-07
                </p>
                
                {/* Código de Barras */}
                <div className="bg-gray-50 p-6 rounded-xl border">
                  <div className="font-mono text-lg font-bold mb-4 tracking-wider">
                    {data.codigoBarras}
                  </div>
                  <div className="flex justify-center mb-6">
                    <div className="h-20 bg-black w-full max-w-lg rounded" style={{
                ...
                <div className="flex justify-center mt-8">
                  <div className="text-center bg-white p-6 rounded-xl shadow-lg border-2 border-green-200">
                    <div className="w-40 h-40 mx-auto bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl flex items-center justify-center mb-4 border-2 border-gray-300">
                      <QrCode className="w-32 h-32 text-gray-400" />
                    </div>
                    <p className="text-lg font-bold mb-2 text-gray-800">Pague via PIX</p>
