        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-gray-900">{generator.owner?.type === 'fisica' ? 'Pessoa Física' : 'Pessoa Jurídica'}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600">
                {generator.owner?.type === 'fisica' ? 'CPF' : 'CNPJ'}
              </label>
              <p className="text-gray-900">{generator.owner?.cpfCnpj}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600">Nome</label>
              <p className="text-gray-900">{generator.owner?.name}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600">Número Parceiro Negócio</label>
              <p className="text-gray-900">{generator.owner?.numeroParceiroNegocio}</p>
            </div>
            {generator.owner?.type === 'juridica' && (
              <>
                <div>
                  <label className="text-sm font-medium text-gray-600">Razão Social</label>
                  <p className="text-gray-900">{generator.owner?.razaoSocial}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-600">Nome Fantasia</label>
                  <p className="text-gray-900">{generator.owner?.nomeFantasia}</p>
                </div>
              </>
            )}
            <div>
          ...
          {generator.owner?.observacoes && (
            <div>
              ...
              <p className="text-gray-900">{generator.owner.observacoes}</p>
            </div>
          )}
        </CardContent>
      </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="text-sm font-medium text-gray-600">Nome</label>
                <p className="text-gray-900">{generator.administrator.nome}</p>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-600">CPF</label>
                <p className="text-gray-900">{generator.administrator.cpf}</p>
              </div>
              <div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-gray-900">{generator.payment_data?.banco}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600">Agência</label>
              <p className="text-gray-900">{generator.payment_data?.agencia}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600">Conta</label>
              <p className="text-gray-900">{generator.payment_data?.conta}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600">PIX</label>
              <p className="text-gray-900">{generator.payment_data?.pix || 'Não informado'}</p>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-gray-900">{generator.distributor_login?.uc}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600">CPF/CNPJ</label>
              <p className="text-gray-900">{generator.distributor_login?.cpfCnpj}</p>
            </div>
            {generator.distributor_login?.dataNascimento && (
              <div>
                <label className="text-sm font-medium text-gray-600">Data de Nascimento</label>
                <p className="text-gray-900">{new Date(generator.distributor_login.dataNascimento).toLocaleDateString('pt-BR')}</p>
              </div>
            )}
          </div>
        </CardContent>
